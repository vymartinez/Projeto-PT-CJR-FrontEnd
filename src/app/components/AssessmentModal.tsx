  ...
  return (
    <>
        <div className='fixed left-0 top-0 right-0 bottom-0 flex justify-center items-center bg-[#F1F1F1]/60 z-[1] flex-col'>
            <div className='bg-secondary md:rounded-t-xl h-full w-full md:h-2/3 md:w-2/3 flex flex-col p-4'>
                <div className='flex flex-col'>
                    <div className='py-3 px-3 flex items-center'>
                        <input type='text' value={teachers} onChange={(e) => setTeachers(e.target.value)} placeholder='Nome do Professor' className='text-sm text-left w-full rounded-full px-3 py-2 outline-none'></input>
                ...
                <div className='flex flex-col'>
                    <div className='py-3 px-3 flex items-center'>
                        <input type='text' value={disciplines} onChange={(e) => setDisciplines(e.target.value)} placeholder='Disciplina' className='text-sm text-left pl-3 rounded-full w-full py-2 outline-none'></input>
                ...
                <div className='h-3/4 w-5/6 container mx-auto pt-3'>
